...
To run the server locally, click the play button next to the `main()` method in `EventsApplication.java`. Your API will be available at `http://localhost:8080`.
